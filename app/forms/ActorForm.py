...
from wtforms import StringField, DateField, TextAreaField, SelectField, FieldList, SubmitField, SelectMultipleField
...
class ActorForm(FlaskForm):
  ...
  bio = TextAreaField("Biography", [Length(max=5000)])
